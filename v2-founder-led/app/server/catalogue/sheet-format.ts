...
export function bundleToSheetTables(bundle: CatalogueBundle): SheetTables {
  ...
  return {
    ...
    Evidence: [
      ...
      ...bundle.compatibility.flatMap((relation) => relation.evidenceIds.map((evidenceId) => ({
        evidence_id: evidenceId,
        source_id: "source-northstar-prototype",
        target_type: "relationship",
        target_id: relation.relationshipId,
        field_or_relation: "compatibility_approval",
        status: "verified",
        confidence: "high",
        reviewer: "Northstar research-led prototype",
      }))),
