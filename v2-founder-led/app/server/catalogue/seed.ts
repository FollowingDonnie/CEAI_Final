...
const variants: Variant[] = [
  ...
  variant({ id: "a08-j-hooks", sku: "NS-A08-UNI", name: "A08 J-Hook Pair", category: "attachment", family: "attachments-bar-support", config: "Northstar governed pair", description: "Required bar supports for approved Northstar rack-and-barbell setups.", price: 8900, width: 120, length: 180, height: 220, tags: ["barbell_strength", "bench_press", "required_setup"], rackInterface: attachment75(), generation: "G2", priority: 10 }),
  variant({ id: "a32-gym-rings", sku: "NS-A32-G2", name: "A32 Gymnastic Rings", category: "attachment", family: "attachments-crossmember", config: "Adjustable strap pair", description: "Adjustable rings for approved Northstar pull-up crossmembers.", price: 7900, width: 500, length: 280, height: 1800, operatingWidth: 1800, operatingLength: 1800, operatingHeight: 2300, tags: ["calisthenics", "rings", "pull_up"], rackInterface: { ...attachment75(), mountingFaces: ["crossmember"] }, generation: "G2", priority: 8 }),
...
export const seedCatalogue: CatalogueBundle = {
  ...
  compatibility: [
    ...
    relation("rel-s10-squat-stand-entry-jhooks", "s10-squat-stand-entry", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-s10-squat-stand-entry-jhooks"] }),
    relation("rel-s20-squat-stand-standard-jhooks", "s20-squat-stand-standard", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-s20-squat-stand-standard-jhooks"] }),
    relation("rel-h30-half-rack-entry-jhooks", "h30-half-rack-entry", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-h30-half-rack-entry-jhooks"] }),
    relation("rel-h40-half-rack-pro-jhooks", "h40-half-rack-pro", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-h40-half-rack-pro-jhooks"] }),
    relation("rel-p40-power-rack-compact-jhooks", "p40-power-rack-compact", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-p40-power-rack-compact-jhooks"] }),
    relation("rel-p50-power-rack-standard-jhooks", "p50-power-rack-standard", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-p50-power-rack-standard-jhooks"] }),
    relation("rel-p60-power-rack-premium-jhooks", "p60-power-rack-premium", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-p60-power-rack-premium-jhooks"] }),
    relation("rel-f20-folding-rack-compact-jhooks", "f20-folding-rack-compact", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-f20-folding-rack-compact-jhooks"] }),
    relation("rel-f30-folding-rack-pro-jhooks", "f30-folding-rack-pro", "a08-j-hooks", "explicitly_compatible", { evidenceIds: ["evidence-rel-f30-folding-rack-pro-jhooks"] }),
    relation("rel-h30-half-rack-entry-rings", "h30-half-rack-entry", "a32-gym-rings", "explicitly_compatible", { evidenceIds: ["evidence-rel-h30-half-rack-entry-rings"] }),
    relation("rel-h40-half-rack-pro-rings", "h40-half-rack-pro", "a32-gym-rings", "explicitly_compatible", { evidenceIds: ["evidence-rel-h40-half-rack-pro-rings"] }),
    relation("rel-p40-power-rack-compact-rings", "p40-power-rack-compact", "a32-gym-rings", "explicitly_compatible", { evidenceIds: ["evidence-rel-p40-power-rack-compact-rings"] }),
    relation("rel-p50-power-rack-standard-rings", "p50-power-rack-standard", "a32-gym-rings", "explicitly_compatible", { evidenceIds: ["evidence-rel-p50-power-rack-standard-rings"] }),
    relation("rel-f30-folding-rack-pro-rings", "f30-folding-rack-pro", "a32-gym-rings", "explicitly_compatible", { evidenceIds: ["evidence-rel-f30-folding-rack-pro-rings"] }),
    relation("rel-h30-spotter", "h30-half-rack-entry", "a12-spotter-arms", "explicitly_compatible", { evidenceIds: ["evidence-rel-h30-spotter"] }),
    relation("rel-h40-half-rack-pro-spotter", "h40-half-rack-pro", "a12-spotter-arms", "explicitly_compatible", { evidenceIds: ["evidence-rel-h40-half-rack-pro-spotter"] }),
    relation("rel-p40-power-rack-compact-spotter", "p40-power-rack-compact", "a12-spotter-arms", "explicitly_compatible", { evidenceIds: ["evidence-rel-p40-power-rack-compact-spotter"] }),
    relation("rel-p50-power-rack-standard-spotter", "p50-power-rack-standard", "a12-spotter-arms", "explicitly_compatible", { evidenceIds: ["evidence-rel-p50-power-rack-standard-spotter"] }),
    relation("rel-f20-folding-rack-compact-spotter", "f20-folding-rack-compact", "a12-spotter-arms", "explicitly_compatible", { evidenceIds: ["evidence-rel-f20-folding-rack-compact-spotter"] }),
    relation("rel-f30-folding-rack-pro-spotter", "f30-folding-rack-pro", "a12-spotter-arms", "explicitly_compatible", { evidenceIds: ["evidence-rel-f30-folding-rack-pro-spotter"] }),
